...
// PARAMETER VARIABEL
	...
	if (isset($_POST['bsimpan'])) {
		...
		($cek > 0) {
			...
			mysqli_query($GLOBALS["___mysqli_ston"],"INSERT INTO score_tbl (sid, agent_name, agent_nik, sum_score, score_date, qa_name, p1a,p1b,p1c,p2a,p2b,p2c,p3a,p3b,p3c,p4a,p4b,p4c,p5a,p5b,p5c,p6a,p6b,p6c, contract_number, media) 
			 value 
			 ('$sid','$agent_name','$agent_nik','$total_score',NOW(),'$qa_name','$sub_par_id_greeting','$sub_par_score_greeting','$note_subtype1g','$sub_par_id_verification','$sub_par_score_verification','$note_subtype2v','$sub_par_id_tov','$sub_par_score_tov','$note_subtype3t','$sub_par_id_pk','$sub_par_score_pk','$note_subtype4p','$sub_par_id_cl','$sub_par_score_cl','$note_subtype5c','$sub_par_id_cp','$sub_par_score_cp','$note_subtype6c','$contract_number','$media')"); 
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        $parDesc = htmlspecialchars($row['par_desc']);
    }
	...
	if (isset($_POST['bcari'])) {
		$text = $_POST['tcari'];
		$cari = "WHERE sid LIKE '%$text%' OR contract_number LIKE '%$text%' OR media LIKE '%$text%' OR type LIKE '%$text%' OR subtype LIKE '%$text%' OR sub_subtype LIKE '%$text%' OR note LIKE '%$text%' OR result LIKE '%$text%' OR agent_name LIKE '%$text%'";
	}else{
		$cari=" WHERE sid != 0";
	}
?>
                        ...
                        <tbody>
                            <?php  
                                ...
                                if ($data=="") {
                                    ...
                                    foreach ($data as $r) {
                                        $cek = $aksi->cekdata("population_tbl WHERE sid = '{$r['sid']}' AND media = 'Inbound Call'");
                                        $no++; ?>
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="panel panel-default" style="padding: 10px; box-shadow: 2px 2px 5px #8c2222;">
                                        <div class="panel-heading">SCORE CARD INBOUND CALL DETAILS</div>
                                        <div class="panel-body">
                                            <form method="post">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <textarea class="form-control" name="par_weight_verification" rows="3" required readonly placeholder="10"></textarea>
                                                            </td>
                                                            <td>
                                                                <div class="form-group">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    <input type="text" name="sub_par_id_cp" class="form-control" value="No" required list="sub_par_name_6c" oninput="updateScoreAndDisplay('sub_par_name_6c', this, 'sub_par_score_cp')">
